...
IBSMSG.Ko = {
  "Lang": {
    "Create": {
      "MultiRecordDiffColLength": "'%1'의 %2번째 단위데이터행의 열 개수가 다릅니다. (기대: %3, 실제: %4)",
      "NoCanUseMultiRecordWithTree": "MultiRecord 기능은 트리 기능(MainCol)과 같이 사용하실 수 없습니다.",
      "TwoDimensionalArray": "MultiRecord 기능은 2차원 배열로 설정해주어야 합니다.",
      "MultiRecordNameErr": "'Name' 속성 설정이 필요합니다. (단위데이터 %1 행, %2 번째 열의 Name 속성 누락)",
      "MustBeArray": "'%1'는 배열이어야 합니다."
    },
    "Alert": {
      "CanReloadStart": "",
      ...
      "ResultErrEmptyResponse": "<span style='color: #ed2f5f; font-weight:bold;'>응답 결과가 비었습니다.</span>",
    ...
    "Text": {
      ...
      "StyleRow": {
        ...
        "InitAll": "모든 시트 초기화",
        "InitSuccess": "스타일이 초기화되었습니다.",
        "InitFail": "스타일 초기화에 실패했습니다.",
        "DeleteFail": "스타일 정보 삭제에 실패했습니다."
      },
    ...
    "DisplayMenu": {
      "ColumnVisibility": "컬럼 표시 여부",
      "ShowColumn": "컬럼 감추기 취소",
      "HideColumn": "컬럼 감추기",
      "ToggleSelectAll": "전체 선택 / 해제",
      "AtLeastOneColumn": "최소 1개의 컬럼은 보여야합니다."
    }
  }
};