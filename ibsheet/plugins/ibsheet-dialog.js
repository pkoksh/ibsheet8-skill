...
Fn.initImportSheet = function (uploadType, width, height, name, colCount, fullLoadData) {
  ...
  var defaultEvents = {
    onRenderFirstFinish: function (evtParams) {
      ...
      if (evtParams.sheet.RowIndex && evtParams.sheet.RowIndex != "SEQ") sheetCols = sheetCols.filter(function(item) { return item !== "SEQ"; });
      var colsMap = "";
