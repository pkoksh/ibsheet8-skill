...
ALIAS_EN: event, called, mouse, button, pressed, sheet, onmousedown
SOURCE_URL: https://docs.ibsheet.com/ibsheet/v8/manual/en/#docs/events/on-mouse-down
---
# onMouseDown ***(event)***
> Event called when the mouse button is pressed on the sheet.

> Returning `1(true)` prevents the default action of `onMouseDown`.
